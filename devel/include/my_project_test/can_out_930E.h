// Generated by gencpp from file my_project_test/can_out_930E.msg
// DO NOT EDIT!


#ifndef MY_PROJECT_TEST_MESSAGE_CAN_OUT_930E_H
#define MY_PROJECT_TEST_MESSAGE_CAN_OUT_930E_H
...
struct can_out_930E_
{
  typedef can_out_930E_<ContainerAllocator> Type;
  ...
  can_out_930E_()
    ...
    , oil_pressure(0)
    , engine_water_cooling(0)  {
    }
  can_out_930E_(const ContainerAllocator& _alloc)
    : driverMode_b(false)
    , gearP_b(false)
    , loadBrake_b(false)
    , turtle_b(false)
  ...
  _elecControlTemp_type elecControlTemp;
   ...
   typedef uint8_t _faultFeedback2_type;
  _faultFeedback2_type faultFeedback2;
  ...
  _bothLamp_b_type bothLamp_b;
   ...
   typedef uint8_t _hydraulic_oil_temperature_type;
  _hydraulic_oil_temperature_type hydraulic_oil_temperature;

   typedef uint16_t _oil_pressure_type;
  _oil_pressure_type oil_pressure;

   typedef uint8_t _engine_water_cooling_type;
  _engine_water_cooling_type engine_water_cooling;





  typedef boost::shared_ptr< ::my_project_test::can_out_930E_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::my_project_test::can_out_930E_<ContainerAllocator> const> ConstPtr;

}; // struct can_out_930E_

typedef ::my_project_test::can_out_930E_<std::allocator<void> > can_out_930E;

typedef boost::shared_ptr< ::my_project_test::can_out_930E > can_out_930EPtr;
typedef boost::shared_ptr< ::my_project_test::can_out_930E const> can_out_930EConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::my_project_test::can_out_930E_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::my_project_test::can_out_930E_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::my_project_test::can_out_930E_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::my_project_test::can_out_930E_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_project_test::can_out_930E_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_project_test::can_out_930E_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_project_test::can_out_930E_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_project_test::can_out_930E_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::my_project_test::can_out_930E_<ContainerAllocator> >
{
  ...
  static const char* value(const ::my_project_test::can_out_930E_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd090eb4b1ca1c4e5ULL;
  static const uint64_t static_value2 = 0x1a33091e3e31ed08ULL;
};

template<class ContainerAllocator>
struct DataType< ::my_project_test::can_out_930E_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::my_project_test::can_out_930E_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::my_project_test::can_out_930E_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.hydraulic_oil_temperature);
      stream.next(m.oil_pressure);
      stream.next(m.engine_water_cooling);
    }
...
template<class ContainerAllocator>
struct Printer< ::my_project_test::can_out_930E_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::my_project_test::can_out_930E_<ContainerAllocator>& v)
  {
    ...
    s << indent << "faultFeedback2: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.faultFeedback2);
    s << indent << "oil: ";
    ...
    s << indent << "hydraulic_oil_temperature: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.hydraulic_oil_temperature);
    s << indent << "oil_pressure: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.oil_pressure);
    s << indent << "engine_water_cooling: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.engine_water_cooling);
  }
};
...
#endif // MY_PROJECT_TEST_MESSAGE_CAN_OUT_930E_H
