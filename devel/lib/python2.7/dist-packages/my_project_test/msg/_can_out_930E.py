...
"""autogenerated by genpy from my_project_test/can_out_930E.msg. Do not edit."""
import sys
...
class can_out_930E(genpy.Message):
  _md5sum = "d090eb4b1ca1c4e51a33091e3e31ed08"
  _type = "my_project_test/can_out_930E"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       driverMode_b,gearP_b,loadBrake_b,turtle_b,takeOver_b,gear,wheelAngle,velocity,rpm,vechleId,engineSpeed,batteryVoltage,faultTotal,dump_bed,loading,faultCode,elecControlTemp,faultFeedback2,oil,mileage,lighting_b,horn_b,leftLamp_b,rightLamp_b,bothLamp_b,hydraulic_oil_temperature,oil_pressure,engine_water_cooling
    ...
    """
    if args or kwds:
      super(can_out_930E, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5Bbh2HB2H4Bb2BI6BHB().pack(_x.driverMode_b, _x.gearP_b, _x.loadBrake_b, _x.turtle_b, _x.takeOver_b, _x.gear, _x.wheelAngle, _x.velocity, _x.rpm, _x.vechleId, _x.engineSpeed, _x.batteryVoltage, _x.faultTotal, _x.dump_bed, _x.loading, _x.faultCode, _x.elecControlTemp, _x.faultFeedback2, _x.oil, _x.mileage, _x.lighting_b, _x.horn_b, _x.leftLamp_b, _x.rightLamp_b, _x.bothLamp_b, _x.hydraulic_oil_temperature, _x.oil_pressure, _x.engine_water_cooling))
